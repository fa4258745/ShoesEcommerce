...
useEffect(() => {
  ...
  return (
    <>
      <div className="hero-section">
        <div className="content-hero-div">
          <h1 className="hero-heading">
            Nike Air Max <span className="orange">NIKE</span>
          </h1>
      ...
      >
    <p onClick={() => setCategory("All")} className={category==="All"?"active-cat":""}>All</p>
<p onClick={() => setCategory("Nike")} className={category==="Nike"?"active-cat":""}>Nike</p>
<p onClick={() => setCategory("Adidas")} className={category==="Adidas"?"active-cat":""}>Adidas</p>
<p onClick={() => setCategory("Reebok")} className={category==="Reebok"?"active-cat":""}>Reebok</p>
<p onClick={() => setCategory("Puma")} className={category==="Puma"?"active-cat":""}>Puma</p>
<p onClick={() => setCategory("Sandals")} className={category==="Sandals"?"active-cat":""}>Sandals</p>
<p onClick={() => setCategory("Clogs")} className={category==="Clogs"?"active-cat":""}>Clogs</p>
<p onClick={() => setCategory("Boots")} className={category==="Boots"?"active-cat":""}>Boots</p>
<p onClick={() => setCategory("Formal")} className={category==="Formal"?"active-cat":""}>Formal</p>
<p onClick={() => setCategory("Flip Flops")} className={category==="Flip Flops"?"active-cat":""}>Flip Flops</p>
<p onClick={() => setCategory("Sketchers")} className={category==="Sketchers"?"active-cat":""}>Sketchers</p>
<p onClick={() => setCategory("Balenciaga")} className={category==="Balenciaga"?"active-cat":""}>Balenciaga</p>
